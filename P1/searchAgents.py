    ...
    def getSuccessors(self, state):
        ...
        Returns successor states, the actions they require, and a cost of 1.
         As noted in search.py:
            ...
            action, stepCost), where 'successor' is a successor to the current state, 'action' is the action required to get there, and 'stepCost' is the incremental cost of expanding to that successor
        """
        successors = []
...
def cornersHeuristic(state, problem):
    ...
    shortest path from the state to a goal of the problem; i.e.  it should be admissible (as well as consistent).
    """
    ...
    while unvisited_corners:
        ...
        for corner in unvisited_corners:
            heuristic_list.append((util.manhattanDistance(current_position, corner), corner))
        shortest_distance, closet_corner = min(heuristic_list)
...
def foodHeuristic(state, problem):
    ...
    up with an admissible heuristic; almost all admissible heuristics will be consistent as well.
    ...
    for pos in food_position:
        heuristic_list.append(mazeDistance(position, pos, problem.startingGameState))
    heuristic = max(heuristic_list)
    return heuristic
